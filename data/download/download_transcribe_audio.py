...
import csv
from data.download.download_youtube import download_vids
from data.download.upload_audio_from_videos import create_audio_path, scrape_audio_from_videos, upload_audio_to_gcloud
from data.download.transcribe_audio_in_cloud import google_transcribe, words_to_csv
from common.google_helpers import download_blob, list_blobs, upload_blob
...
if __name__ == "__main__":
    ...
    print("path exists? ", videos_path, os.path.exists(videos_path))
    print("path has videos? ", len(os.listdir(videos_path)))
